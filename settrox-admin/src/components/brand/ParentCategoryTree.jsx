...
`;
  ...
  const handleSelect = (key) => {
    ...
    if(typeof selectedDataObj.parentId === 'undefined'){  
      return notifyError("Select subcategory only!");
    } 
    ...
    if (result !== undefined) {
      ...
      if (getCategory.length !== 0) {
        return notifyError("This category already selected!");
      }
...
export default ParentCategoryTree;
